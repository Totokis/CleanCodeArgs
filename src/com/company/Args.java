    ...
    private void parseSchemaElement(String element) throws ParseException {
        ...
        if(isBooleanSchemaElement(elementTail))
            ...
            throw new ParseException(
                    String.format("Argument: %c ma nie właściwy format: $s. ",elementId,elementTail),0);
        }
    }

    private void validateSchemaElementId(char elementId) throws ParseException {
        if(!Character.isLetter(elementId)){
            throw new ParseException("Zły znak: "+elementId + " w formacie Args: " + schema,0);
        }
    }
    ...
    public String errorMessage() throws Exception{
        switch (errorCode){
            ...
            case INVALID_INTEGER:
                return String.format("Argument -%c oczekuje liczby całkowitej a był '%s'.",errorArgumentId,errorParameter);
